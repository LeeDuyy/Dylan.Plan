...
| Business rule | `knowledge/business-rule/` | — (38 trang; `BR-024` `Superseded` bởi `BR-036`; xem `feature-index.md` để tra theo function) |
...
| Số concept / business rule / workflow / entity | 0 / 38 / 0 / 7 |
